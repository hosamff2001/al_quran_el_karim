...
class AppConstants {
  ...
  static Uri quranAppurl =
      Uri.parse('https://github.com/hosamff2001/al_quran_el_karim');

  static void saveSettings() {
    CashHelper.setdata(key: 'arabicFontSize', value: arabicFontSize.toInt());
  ...
  static saveBookMark(surah, ayah) {
    CashHelper.setdata(key: "surah", value: surah);
    CashHelper.setdata(key: "ayah", value: ayah);
  }
